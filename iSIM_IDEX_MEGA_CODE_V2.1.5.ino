...
// fix for movement error:

// Add this at the top with your other globals:
...
void loop() {
  ...
  // Send periodic keepalive to prevent Tic command timeout
  if (millis() - lastTicKeepalive >= TIC_KEEPALIVE_MS) {
